    ...
    (function() {
      ...
      /* 行为 */ {
        ...
        var action_submit = function(p/* Var param */) {
          ...
          //写入时间
          d.setHours(parseInt(calendar_hours[0].value));
          d.setMinutes(parseInt(calendar_minutes[0].value));
          d.setSeconds(parseInt(calendar_seconds[0].value));
...
//<<<
        ...
        var display = function(e/* Object event */) {
          ...
          try {
            ...
            jQuery(calendar).css({
              ...
              'left' : (jQuery(t).offset().left - 6) + 'px',
              'top'  : (jQuery(t).offset().top + jQuery(t).height() + 3) + 'px'
            ...
            if(a.indexOf('m') > -1) {
              ...
              jQuery(calendar_minutes).parent().attr('class', true); $ = true;
            ...
            if(a.indexOf('s') > -1) {
              ...
              jQuery(calendar_seconds).parent().attr('class', true); $ = true;
      ...
      /* 绑定 */ {
        ...
        jQuery(calendar).focusin(function (e) {e.stopPropagation()});
        //显示
