...
proxyuserxmlog = {
	all : '/manage/proxyuserxm/queryProxyuserxm.do',// 加载所有
	save : "/manage/proxyuserxm/save/",//入账
	verify : "/manage/proxyuserxm/verify/",//审核
...
/** 顶部工具栏 */
proxyuserxmlog.tbar = [proxyuserxmlog.addAction,'&nbsp;',proxyuserxmlog.verifyAction,'&nbsp;','-', proxyuserxmlog.searchField];
/** 底部工具条 */
