...
module = {
	all : '/manage/activity/queryLottery.do',// 加载所有
	save : "/manage/activity/modifyLottery.do",//保存
...
module.addAction = new Ext.Action({
			...
			// 发送请求
			Share.AjaxRequest({
						url : "/manage/activity/modifyLottery.do",
						params : {},
