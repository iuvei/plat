...
public class CardPackage extends BaseEntity {
	...
	// columns END
	private java.lang.String account;//会员账号
	private java.lang.String trueName;//会员名字
	...
	public String toString() {
		return new ToStringBuilder(this).append("Cpid", getCpid())
				...
				.append("Alipayname", getAlipayname()).append("Alipay", getAlipay()).toString();
	}
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getCpid(), other.getCpid())
				...
				.append(getUpdateDate(), other.getUpdateDate()).append(getAlipayname(), other.getAlipayname())
				.append(getAlipay(), other.getAlipay()).isEquals();
	}
