...
public abstract class BaseIbatisDAO extends SqlMapClientDaoSupport {
	...
	public Serializable save(String statementName,BaseEntity entity) {
		prepareObjectForSaveOrUpdate(entity);
		Object primaryKey = getSqlMapClientTemplate().insert(statementName,
				entity);
		return (Serializable) entity;
	}
	...
	public List queryForPager(String statementName, Map<String, Object> values, int startNo,
			int pagaSize) {
	...
	public long getRecordCount(String statementName, Map<String, Object> values) {
	...
	public Object queryForObject(String statementName, Map<String, Object> values) {
