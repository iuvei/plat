	...
	<body>
	 ...
	 <div class="container-fluid" id="main-container">
			...
			<div id="main-content" class="clearfix">
					...
					<div id="page-content" class="clearfix">
						<div class="page-header position-relative" style="padding-bottom:0px;">
								<!-- 条件查询开始 -->
								<form class="form-inline" action="${ctx}userproxy/queryProxyClearing.do" method="post" name="queryProxyClearingFrm">
									...
									<button type="submit" class="btn btn-primary _queryProxyClearingFrm"><i class="icon-search icon-on-right"></i>搜索</button>
								</form>
							</div>
								...
								<table id="table_paylog" class="table table-striped table-bordered table-hover">
									<tbody>
										...
										<tr>
											...
											<td colspan="2">
												<font color="red">小提示：实际盈亏 = 游戏输赢-(总洗码+总优惠)</font>
											</td>
										</tr>
										<tr>
											<td>
		...
		$(function(){
			...
			$("._queryProxyClearingFrm").click(function(){
				queryProxyClearingFrm.submit();
			});
			
			$(".nav-list").find("li").removeClass("active");
			$("#queryProxyClearing",".nav-list").addClass("active");
		});
	</script>
	</body>
</html>