	 ...
	 <div class="container-fluid" id="main-container">
			...
			<div id="main-content" class="clearfix">
						...
						<ul class="breadcrumb">
							...
							<li class="active">会员扣款记录</li>
						</ul>
						</div><!--#breadcrumbs-->
						<!--.breadcrumb-->
						<div id="page-content" class="clearfix">
							<div class="page-header position-relative" style="padding-bottom:0px;">
								<form class="form-search" action="${ctx}userproxy/queryPunishOrderLog.do" method="post" name="punishOrderlogsFrm">
											<span class="input-icon">
												<label>会员账号：</label>
												<input type="text" name="account" class="form-control" style="width: 100px;" value="${pd.uaccount}">
											</span>
											<span class="input-icon">
												<label>开始时间：</label>
											...
											<span class="input-icon">
												...
												<button type="submit" class="btn btn-purple btn-small _querypunishOrderFrm">搜索<i class="icon-search icon-on-right"></i></button>
											</span>
									</form>
							</div>
										...
										<c:if test="${not empty orderList}">
											<c:forEach items="${orderList }" var="order">
												<tr>
													...
													<c:if test="${order.paytyple == 3}">
														<th class="text-danger">扣款</th>
													</c:if>
		...
		$(function(){
			...
			$("._querypunishOrderFrm").click(function(){
				punishOrderlogsFrm.submit();
			});
			...
			$("#queryPunishOrderLog",".nav-list").addClass("active");
		});
	</script>
	</body>
</html>