...
public class ProxyReportEntity extends BaseEntity {
	...
	public String toString() {
		return "ProxyReportEntity [proxyid=" + proxyid + ", proxyaccount=" + proxyaccount + ", proxyname=" + proxyname
				+ ", proxydomain=" + proxydomain + ", clearingtype=" + clearingtype + ", returnscale=" + returnscale
				+ ", ximascale=" + ximascale + ", ximaStatus=" + ximaStatus + ", betTotel=" + betTotel + ", lowerUser="
				+ lowerUser + ", lowecCount=" + lowecCount + ", activeUser=" + activeUser + ", payusercount="
				+ payusercount + ", paycount=" + paycount + ", payAmountTotal=" + payAmountTotal + ", atmcount="
				+ atmcount + ", atmusercount=" + atmusercount + ", atmAmountTotal=" + atmAmountTotal
				+ ", betAmountTotal=" + betAmountTotal + ", validBetAmountTotal=" + validBetAmountTotal
				+ ", winlossTotal=" + winlossTotal + ", preferentialTotal=" + preferentialTotal + ", ximaAmountTotal="
				+ ximaAmountTotal + ", realPLs=" + realPLs + ", commissionAmount=" + commissionAmount
				+ ", buckleAmount=" + buckleAmount + ", sdximaAmount=" + sdximaAmount + ", proxyXimaAmount="
