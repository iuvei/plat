 ...
 *
 */
public class AESEncryptDecryt {

	private static byte[] keyValue = new byte[] {       //用户密钥  
        22,25,-35,-40,25,98,-55,-45,10,35,-45,25,  
        26,-95,25,-65,-78,-99,85,45,-62,10,-0,11,  
        -35,48,-98,65,-32,14,-78,25,36,-56,-45,-45,  
        12,15,-35,-75,15,-14,52,-25,33,-45,55,68,-88  
    };  
    private static byte[] iv = new byte[] {             //算法参数  
        -12,35,-25,65,-45,-87,95,-22,-15,45,95,-66,32,5-4,84,55  
    };
    ...
    static{       
        ...
        try {  
            ...
            ecipher = Cipher.getInstance(CIPHER_AES);         
    ...
    public static void main(String[] args) {
		System.out.println("U:"+encrypt("root"));
