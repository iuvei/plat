...
public class PayPlatform extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Ppid", getPpid())
	...
	public int hashCode() {
		return new HashCodeBuilder().append(getPpid()).append(getPname())
				.append(getDomainname()).append(getPlatformkey())
				.append(getCiphercode()).append(getReturnUrl())
				.append(getNoticeUrl()).append(getStatus())
				.append(getCreateDate()).append(getUpdateDate()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof PayPlatform == false)
			return false;
		if (this == obj)
			return true;
		PayPlatform other = (PayPlatform) obj;
		return new EqualsBuilder().append(getPpid(), other.getPpid())
