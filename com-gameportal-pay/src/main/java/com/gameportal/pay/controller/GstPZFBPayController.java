...
public class GstPZFBPayController extends BasePayController {
	private static final Logger logger = Logger.getLogger(GstPZFBPayController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/gstpzfb/callback")
	@ResponseBody
	public void callBack(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			if (tradeStatus.equals("success")) {
				...
				// 2.验签
				PayPlatform payPlat = payPlatformService.queryPayPlatform(45L);
