...
public class ThPayController extends BasePayController {
	...
	public void callBack(HttpServletRequest req, HttpServletResponse resp) throws Exception {
		...
		try {
			...
			PayPlatform payPlat = payPlatformService.queryPayPlatform(8L);
