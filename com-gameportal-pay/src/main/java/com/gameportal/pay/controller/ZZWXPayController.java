...
public class ZZWXPayController extends BasePayController {
	private static final Logger logger = Logger.getLogger(ZZWXPayController.class);
	...
	public void callBack(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			logger.error("掌智web微信支付后台回调失败。", e);
			out.print("fail");
			return;
		}
		out.print("success");
