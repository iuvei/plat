...
public class YPZFBPayController extends BasePayController {
	private static final Logger logger = Logger.getLogger(YPZFBPayController.class);
...
//				response.sendRedirect(json.getString("msg"));
	...
	public void callBack(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		try {
			...
			PayPlatform payPlat = payPlatformService.queryPayPlatform(224L);
