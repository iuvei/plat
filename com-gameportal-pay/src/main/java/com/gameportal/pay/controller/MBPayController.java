...
public class MBPayController extends BasePayController {
	private static final Logger logger = Logger.getLogger(MBPayController.class);
			...
			if (notifyType.equals("0")) { // 0-页面跳转通知，不处理业务 1-服务器异步通知
				...
				if (orderStatus.equals("1")) {
					...
					if (order.getStatus() == 3) {
						...
						// 2.验签
						PayPlatform payPlat = payPlatformService.queryPayPlatform(4L);
