...
public class SHBZFBPayController extends BasePayController {
	private static final Logger logger = Logger.getLogger(SHBZFBPayController.class);
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/shbzfb/callback")
	@ResponseBody
