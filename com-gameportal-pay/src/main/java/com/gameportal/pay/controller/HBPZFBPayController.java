...
public class HBPZFBPayController extends BasePayController {
	private static final Logger logger = Logger.getLogger(HBPZFBPayController.class);
...
//					response.addHeader("refresh", "5;url=http://" + json.getString("msg"));
	 ...
	 * @throws Exception
	 */
	@RequestMapping("/hebaopzfb/callback")
	@ResponseBody
