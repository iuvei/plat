...
public class LPPQQPayController extends BasePayController {
	private static final Logger logger = Logger.getLogger(LPPQQPayController.class);
...
//				requestMap.put("reqReserved", lp.getReqReserved());
	...
	private void redirect(LePayment lp, String code_img_url, PrintWriter writer) {
		...
		out += "<span class=\"ico-wechat\"></span><span class=\"text\">QQ扫码支付</span>";
		out += "</h1>";
