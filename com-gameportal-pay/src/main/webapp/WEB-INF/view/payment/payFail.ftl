	 	...
	 	<div style="width:100%;height:100%;text-align:center;margin-top:10%;">
        	<div>
                <table width="200px" border="0" cellpadding="0" cellspacing="0" align="center">
        			<tr>
        				<td><label><img src="/images/x.png"/></label></td>
        				<td align="left"><label style="color:#006d04;font-size:16px;font-weight:bold;"><#if order??>该笔订单支付失败！<#else>该笔订单不存!</#if></label></td>
        			</tr>
        		</table>
            </div>
            <#if order??>
            <div style="border:1px solid gray;width: 450px; height: 200px;margin-top:5px;background-color:#ffffdd;">
               ...
               <div style="font-family:微软雅黑; font-size:12px; color:#333333;">本次支付失败，请重新支付或下单。</div>
               </div>
              </#if>
            </div>
        </div>
