...
public class TranIdUtil {
	...
	public static String  generateTranID(){
		...
		tranId++;
		Date date = new Date();
		StringBuffer tran = new StringBuffer("ZR")
									.append(String.format("%ty",date))
									.append(String.format("%tm",date))
									.append(String.format("%td",date))
									.append(String.format("%tH",date))
									.append(String.format("%tM",date))
									.append(String.format("%tS",date))
									.append(String.format("%04d",tranId));
