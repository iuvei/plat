 ...
 */
public class LiveUserPO extends UserPO {
	 ...
	 * 用户筹码
	 */
	private List<UserChipsPO> userChipList;
	...
	@JsonIgnore
	public UserIsBetEnum getIsBetEnum() {
		return UserIsBetEnum.get(this.isBet);
	}
	
	@JsonIgnore
	public LiveUserTypeEnum getTypeEnum() {
		return LiveUserTypeEnum.get(this.type);
	}
	...
	public List<UserChipsPO> getUserChipList() {
		return userChipList;
	}
	public void setUserChipList(List<UserChipsPO> userChipList) {
