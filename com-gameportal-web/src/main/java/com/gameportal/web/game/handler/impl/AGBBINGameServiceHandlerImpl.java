...
public class AGBBINGameServiceHandlerImpl implements IGameServiceHandler {
	...
	public Object createAccount(UserInfo userInfo, GamePlatform gamePlatform, Map paramMap) {
		...
		String username = WebConst.AG_BBIN_USERNAME_PREFIX + userInfo.getAccount();
		Blowfish bf = new Blowfish(WebConst.DECRYPT_KEY);
		String params = "cagent=" + gamePlatform.getCiphercode() + WebConst.API_URL_PARAM_SPLIT + "loginname="
				+ username + WebConst.API_URL_PARAM_SPLIT;
		params += "method=lg" + WebConst.API_URL_PARAM_SPLIT + "actype=1" + WebConst.API_URL_PARAM_SPLIT + "password="
				+ bf.decryptString(userInfo.getApipassword()) + WebConst.API_URL_PARAM_SPLIT + "cur=CNY";
	...
	public Object loginGame(UserInfo userInfo, GamePlatform gamePlatform, Map paramMap) {
		...
		String params = "cagent=" + gamePlatform.getCiphercode() + WebConst.API_URL_PARAM_SPLIT + "loginname="
				+ username + WebConst.API_URL_PARAM_SPLIT;
		params += "actype=1" + WebConst.API_URL_PARAM_SPLIT + "password=" + bf.decryptString(userInfo.getApipassword())
				+ WebConst.API_URL_PARAM_SPLIT + "dm="+paramMap.get("dm") + WebConst.API_URL_PARAM_SPLIT + "sid=" + sid
				+ WebConst.API_URL_PARAM_SPLIT;
		params += "lang=1" + WebConst.API_URL_PARAM_SPLIT + "gameType=" + gameType + WebConst.API_URL_PARAM_SPLIT
				+ "cur=CNY";
		logger.info("request param-->" + params);
		EncryptDecryt ende = new EncryptDecryt(gamePlatform.getDeskey());
		params = ende.encrypt(params);
	...
	public Object deposit(UserInfo userInfo, GamePlatform gamePlatform, String amount, Map paramMap) {
		...
		String username = WebConst.AG_BBIN_USERNAME_PREFIX + userInfo.getAccount();
		Blowfish bf = new Blowfish(WebConst.DECRYPT_KEY);
		String params = "cagent=" + gamePlatform.getCiphercode() + WebConst.API_URL_PARAM_SPLIT + "method=tc"
				+ WebConst.API_URL_PARAM_SPLIT + "loginname=" + username + WebConst.API_URL_PARAM_SPLIT + "billno="
				+ billNo + WebConst.API_URL_PARAM_SPLIT;
		params += "type=IN" + WebConst.API_URL_PARAM_SPLIT + "credit=" + credit + WebConst.API_URL_PARAM_SPLIT
				+ "actype=1" + WebConst.API_URL_PARAM_SPLIT + "password=" + bf.decryptString(userInfo.getApipassword())
	...
	public Object queryBalance(UserInfo userInfo, GamePlatform gamePlatform, Map paramMap) {
		...
		String params = "cagent=" + gamePlatform.getCiphercode() + WebConst.API_URL_PARAM_SPLIT + "loginname="
				+ username + WebConst.API_URL_PARAM_SPLIT;
		params += "method=gb" + WebConst.API_URL_PARAM_SPLIT + "actype=1" + WebConst.API_URL_PARAM_SPLIT + "password="
				+ bf.decryptString(userInfo.getApipassword()) + WebConst.API_URL_PARAM_SPLIT + "cur=CNY";
		logger.info("request param--->" + params);
		EncryptDecryt ende = new EncryptDecryt(gamePlatform.getDeskey());
		params = ende.encrypt(params);
	...
	public Object withdrawal(UserInfo userInfo, GamePlatform gamePlatform, String amount, Map paramMap) {
		...
		String params = "cagent=" + gamePlatform.getCiphercode() + WebConst.API_URL_PARAM_SPLIT + "method=tc"
				+ WebConst.API_URL_PARAM_SPLIT + "loginname=" + username + WebConst.API_URL_PARAM_SPLIT + "billno="
				+ billNo + WebConst.API_URL_PARAM_SPLIT;
		params += "type=OUT" + WebConst.API_URL_PARAM_SPLIT + "credit=" + credit + WebConst.API_URL_PARAM_SPLIT
				+ "actype=1" + WebConst.API_URL_PARAM_SPLIT + "password=" + bf.decryptString(userInfo.getApipassword())
				+ WebConst.API_URL_PARAM_SPLIT + "cur=CNY";
		logger.info("request param--->" + params);
		EncryptDecryt ende = new EncryptDecryt(gamePlatform.getDeskey());
	...
	public Object transferCreditConfirm(UserInfo userInfo, GamePlatform gamePlatform, Map paramMap) {
		...
		Blowfish bf = new Blowfish(WebConst.DECRYPT_KEY);
		String params = "cagent=" + gamePlatform.getCiphercode() + WebConst.API_URL_PARAM_SPLIT + "loginname="
				+ username + WebConst.API_URL_PARAM_SPLIT + "method=tcc" + WebConst.API_URL_PARAM_SPLIT + "billno="
				+ billNo + WebConst.API_URL_PARAM_SPLIT;
		params += "type=" + paramMap.get("type") + WebConst.API_URL_PARAM_SPLIT + "credit=" + credit
				+ WebConst.API_URL_PARAM_SPLIT + "actype=1" + WebConst.API_URL_PARAM_SPLIT + "flag=1"
				+ WebConst.API_URL_PARAM_SPLIT + "password=" + bf.decryptString(userInfo.getApipassword())
				+ WebConst.API_URL_PARAM_SPLIT + "cur=CNY";
		logger.info("request param--->" + params);
		EncryptDecryt ende = new EncryptDecryt(gamePlatform.getDeskey());
		params = ende.encrypt(params);
	...
	public Object queryOrderStatus(UserInfo userInfo, GamePlatform gamePlatform, Map paramMap) {
		String billNo = String.valueOf(paramMap.get("billno"));
		String url = gamePlatform.getDomainname() + "/doBusiness.do";
		String params = "cagent=" + gamePlatform.getCiphercode() + WebConst.API_URL_PARAM_SPLIT + "billno=" + billNo
				+ WebConst.API_URL_PARAM_SPLIT;
