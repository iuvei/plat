...
public class GamePlatform extends BaseEntity {
	...
	public GamePlatform(java.lang.Long gpid) {
		this.gpid = gpid;
	}
	...
	public String toString() {
		return new ToStringBuilder(this).append("Gpid", getGpid())
				...
				.append("FullName",getFullname()).toString();
		
	}

	public int hashCode() {
		return new HashCodeBuilder().append(getGpid()).append(getGpname())
				.append(getDomainname()).append(getDomainip())
				.append(getDeskey()).append(getApiaccount())
				.append(getCiphercode()).append(getStatus())
				.append(getCreateDate()).append(getUpdateDate()).toHashCode();
	}

	public boolean equals(Object obj) {
		if (obj instanceof GamePlatform == false)
			return false;
		if (this == obj)
			return true;
		GamePlatform other = (GamePlatform) obj;
		return new EqualsBuilder().append(getGpid(), other.getGpid())
