 ...
 *
 */
public class AGElectronic extends BaseEntity {
	...
	public String toString() {
		return "MGElectronic [electronicid=" + electronicid + ", category=" + category + ", categoryID=" + categoryID + ", gameEnName=" + gameEnName
				+ ", imageFileName=" + imageFileName + ", gameName=" + gameName + ", gameNameCN=" + gameNameCN + ", sequence=" + sequence
				+ ", status=" + status + "]";
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((gameEnName == null) ? 0 : gameEnName.hashCode());
		result = prime * result + ((gameName == null) ? 0 : gameName.hashCode());
		result = prime * result + ((gameNameCN == null) ? 0 : gameNameCN.hashCode());
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		AGElectronic other = (AGElectronic) obj;
		if (category == null) {
