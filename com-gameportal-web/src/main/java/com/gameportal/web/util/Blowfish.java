...
public class Blowfish {
	...
	public static void main(String[] args) {
		Blowfish chiper = new Blowfish("GAMEWEB");
		System.out.println(chiper.encryptString("123456"));
		System.out.println(chiper.decryptString("122b03a64813b673053f07ab6ebda72aa7db1bef327d5dc1"));
	}
}