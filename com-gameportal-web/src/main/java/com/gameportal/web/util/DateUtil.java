...
public class DateUtil {
	 ...
	 * @return
	 */
	public static Date getCouponEndTime(Date startDate, Integer days){
		Calendar calendar = Calendar.getInstance();
		calendar.setTime(startDate);
		calendar.add(Calendar.DATE, days);
		String endTimeStr = getStrYMDByDate(calendar.getTime())+" 23:59:59";
		return getDateByStr(endTimeStr);
	}
	/**
	 * 对月数进行加减运算
	 * 
	 ...
	 * @return
	 */
	public static Long getBetweenMin(Date startDate,Date endDate){
		if(null == startDate ||
				null == endDate){
			return 0L;
		}
	 ...
	 * @return
	 */
	public static String getYesterday(Date date,int step){
		Calendar c = Calendar.getInstance();
		c.setTime(date);
		c.add(Calendar.DATE, step);
	...
	public static String getMondayOfLastWeek() {
		...
		c.add(Calendar.DATE, -dayOfWeek + 1);
		return getYesterday(c.getTime(), -7);
	}
	...
	public static String getSundayOfLastWeek() {
		...
		c.add(Calendar.DATE, -dayOfWeek + 1);
		return getYesterday(c.getTime(), -1);
	}
	...
	public static void main(String[] args) {
		Date date = getDateByUsa(new Date());
		SimpleDateFormat sdf = new SimpleDateFormat("yyyy/MM/dd");
//		System.out.println(getStrByDate(getCurrYearFirst(), "yyyy-MM-dd"));
		try {
			System.out.println(DateUtil.getStrByDate(sdf.parse("2016/11/20"),"MM-dd"));
