...
public class Activity extends BaseEntity {
	...
	public String toString() {
		return "Activity [aid=" + aid + ", hdtype=" + hdtype + ", hdnumber=" + hdnumber + ", hdtext=" + hdtext
				+ ", hdscale=" + hdscale + ", multiple=" + multiple + ", isxima=" + isxima + ", notecontext="
				+ notecontext + ", status=" + status + ", uptime=" + uptime + ", maxmoney=" + maxmoney + ", minmoney="
				+ minmoney + "]";
	}
	
	@Override
	public boolean equals(Object obj) {
		return getHdnumber().equals(((Activity)obj).getHdnumber());
	}
