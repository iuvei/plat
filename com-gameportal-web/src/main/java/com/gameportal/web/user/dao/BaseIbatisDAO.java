...
public abstract class BaseIbatisDAO extends SqlMapClientDaoSupport {
	...
	public List queryForList(Map values) {
		return this.getSqlMapClientTemplate().queryForList(getListQuery(), values);
	}
	...
	public String getListQuery() {
		return getSimpleName() + ".queryAll";
	}
	
	public String getSingleQuery() {
		return getSimpleName() + ".singleQuery";
	}
