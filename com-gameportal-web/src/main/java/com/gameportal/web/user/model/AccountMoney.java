...
public class AccountMoney extends BaseEntity {
	...
	public String toString() {
		return new ToStringBuilder(this).append("Amid", getAmid())
				.append("Uiid", getUiid())
	...
	public int hashCode() {
		return new HashCodeBuilder().append(getAmid()).append(getUiid())
				.append(getTotalamount()).append(getStatus())
	...
	public boolean equals(Object obj) {
		...
		return new EqualsBuilder().append(getAmid(), other.getAmid())
