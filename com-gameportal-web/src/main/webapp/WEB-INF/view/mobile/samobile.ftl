...
<html>
	<head>
		...
		<title id="apptitle">SA电子游戏</title>
	...
	<body>
		...
		<div ui-view="" class="app ng-scope">
			<div class="navbar navbar-app navbar-absolute-top ng-scope">
				<div class="navbar-brand navbar-brand-center ng-binding" ui-yield-to="title">SA 电子</div>
					...
					<div class="scrollable-index">
						<div class="scrollable-con" afkl-image-container="">
							...
							<div class="game-content ng-scope" ng-if="mgList.length>0">
								...
								<div class="game-item ng-scope" onclick="javascript:<#if open>window.location.href='${action_path}mobile/loginSamp.html?gameCode=${electronic.gameId}&type=1';<#else>ui.msg('游戏维护中,请稍后!',3)</#if>"" ng-repeat="item in mgList"><span afkl-lazy-image="${zy_path}images/sa/ano.png" afkl-lazy-image-options="{&quot;offset&quot;: 0}" class="" afkl-lazy-image-loaded="done"><img src="${zy_path}mstatic/images/msa/${electronic.gameId}.png"></span>
		...
		<form action="/game/samp.do" name="ptmobile" style="display:none;">
