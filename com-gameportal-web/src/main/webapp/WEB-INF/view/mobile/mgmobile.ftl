...
<html>
	<head>
		...
		<title id="apptitle">MG电子游戏</title>
	...
	<body>
		...
		<div ui-view="" class="app ng-scope">
			<div class="navbar navbar-app navbar-absolute-top ng-scope">
				<div class="navbar-brand navbar-brand-center ng-binding" ui-yield-to="title">MG 电子</div>
					...
					<div class="scrollable-index">
						<div class="scrollable-con" afkl-image-container="">
							...
							<div class="game-content ng-scope" ng-if="mgList.length>0">
								...
								<div class="game-item ng-scope" onclick="javascript:<#if open>window.location.href='/mobile/loginMGmp/${electronic.moduleID}/${electronic.clientID}.html';<#else>ui.msg('游戏维护中,请稍后!',3)</#if>" ng-repeat="item in mgList"><span afkl-lazy-image="${zy_path}images/pt/ano.png" afkl-lazy-image-options="{&quot;offset&quot;: 0}" class="" afkl-lazy-image-loaded="done">
								<img src="${zy_path}images/newmg/${electronic.imageFileName}" style="height:85px;"></span>
		...
		<form action="/game/mgmp.do" name="ptmobile" style="display:none;">
