...
export class DashboardComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    //this.mainChartData=[{"data":[19945.00,16809.00,0.00,15080.00,0.00,0.00],"label":"CREDITAGENT"},{"data":[18400.00,18523.00,0.00,16.00,27274.00,10.50],"label":"APIAGENT"}];
    // this.mainChartLabels=["12-20","12-21","12-22","12-23","12-25","12-26"];
  ...
  getBetRank() {
    this.http.post(this.url + '/statistics/queryBetTotalRankByDay',{}).map((res: Response) => res.json())
      .subscribe(r => {
          if(r.data.mainChartData.length>0) {
